...
namespace LINQPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var productsWithPricesInRange10To20OrderedByPriceAsc = from product in products orderby product.Price ascending where product.Price >= 10.00 && product.Price <= 20.00 select product;
            ...
            var titlesForProductsWithPricesInRange10To20OrderedByTitleAsc = from product in products where product.Price >= 10.00 && product.Price <= 20.00 orderby product.Title ascending select product.Title;
            ...
            var idsForProductsWithPricesInRange10To20OrderedByIDDesc = from product in products where product.Price >= 10.00 && product.Price <= 20.00 orderby product.ID ascending select product.ID;
            var idsForProductsWithPricesInRange10To20OrderedByIDDescFunctional = products.Where(product => product.Price >= 10.00 && product.Price <= 20.00).OrderBy(product => product.ID).Select(product => product.ID);
            ...
            var productTitleWithID3152 = (from product in products where product.ID == 3152 select product.Title).First();
            var productTitleWithID3152Functional = products.Where(product => product.ID == 3152).Select(products => products.Title).First();
            ...
            var petProductsLowestToHighestPriceFunctional = products.Where(product => product.Category == ProductCategory.Pet).OrderBy(products => products.Price);
            ...
            var lowStock = from product in products where product.StockedQuantity < 20 select new { Title = product.Title, Quantity = product.StockedQuantity };
            var lowStockFunctional = products.Where(product => product.StockedQuantity < 20).Select(product => new { Title = product.Title, Quantity = product.StockedQuantity });
            ...
            var lowStockOrderedByStockedQuantity = from product in products where product.StockedQuantity < 20 orderby product.StockedQuantity ascending select new { Title = product.Title, Quantity = product.StockedQuantity };
            var lowStockOrderedByStockedQuantityFunctional = products.Where(product => product.StockedQuantity < 20).OrderBy(product => product.StockedQuantity).Select(product => new { Title = product.Title, Quantity = product.StockedQuantity });
